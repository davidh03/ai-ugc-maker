...
export function updateWorkflow(workflow = [], stage, patch = {}) {
  ...
  const stageToNode = { composing: 'compose', 'prompt-optimizing': 'prompt-optimizer', 'web-research': 'web-research', 'asset-analysis': 'asset-analysis', voiceover: 'voiceover', linting: 'lint', rendering: 'render', 'music-mix': 'music', complete: 'complete', brief: 'brief', compose: 'compose', lint: 'lint', render: 'render', music: 'music' };
